...
export const EditModule = () => {
  ...
  const { mutate, isPending } = useMutation({
    mutationFn: () =>
      updateModule({ name: module['Module Name'], code: id, students }, id),
    ...{
      onSuccess() {
        toast.success(`${module['Module Name']} updated successfully`);
  ...
  return isLoading ? (
    ...
    <div className='w-full flex flex-col p-8'>
      ...
      <h1 className='text-2xl mt-6'>Edit {module['Module Name']} students</h1>
